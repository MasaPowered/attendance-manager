...
CMD php artisan route:clear && php artisan config:clear && php artisan cache:clear && php artisan migrate --force && php artisan db:seed --class=AdminSeeder --force && /start.sh